...
Debugging code in an everyday task for developers. In a recent video, I presented [how to debug R code in RStudio IDE](https://www.youtube.com/watch?v=WB5e8P2KHhI).
...
# Debugging code in the R console

Before showing you how to use the specific VSCode debugger, let's see how to debug the code in the R console.
...
The experience of R programming in VSCode is very pleasant. However, one of the last drawbacks that I had was to get the equivalent of the RStudio debugging process. Thanks to the R Debugger extension, this is now possible !

I hope this blog post was useful to you, and that the debugging process, which is a stressful task whatsoever, will be easier for you now !